...
class ListadoCobranzasScreen extends StatefulWidget {
  const ListadoCobranzasScreen({super.key});

  @override
  State<ListadoCobranzasScreen> createState() => _ListadoCobranzasScreenState();
}

class _ListadoCobranzasScreenState extends State<ListadoCobranzasScreen> {
  var isLoading=true;
  List<PlutoRow> rows= [];
