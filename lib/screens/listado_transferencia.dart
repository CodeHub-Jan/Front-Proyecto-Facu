...
class ListadoTransferencia extends StatefulWidget {
  const ListadoTransferencia({super.key});

  @override
  State<ListadoTransferencia> createState() => _ListadoTransferenciaState();
}

class _ListadoTransferenciaState extends State<ListadoTransferencia> {
  var isLoading=true;
  List<PlutoRow> rows= [];
