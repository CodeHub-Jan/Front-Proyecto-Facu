...
class ListadoOpScreen extends StatefulWidget {
  const ListadoOpScreen({super.key});

  @override
  State<ListadoOpScreen> createState() => _ListadoOpScreenState();
}

class _ListadoOpScreenState extends State<ListadoOpScreen> {
  var isLoading=true;
  List<PlutoRow> rows= [];
          ...
          child: PlutoGrid(
            ...
            SizedBox(
              ...
              child: EmptyWidget(
                ...
                title: 'Todavia no tenemos ningun orden de pago registrado',
