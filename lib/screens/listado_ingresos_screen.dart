...
class ListadoIngresoScreen extends StatefulWidget {
  const ListadoIngresoScreen({super.key});

  @override
  State<ListadoIngresoScreen> createState() => _ListadoIngresoScreenState();
}

class _ListadoIngresoScreenState extends State<ListadoIngresoScreen> {
  var isLoading=true;
  List<PlutoRow> rows= [];
